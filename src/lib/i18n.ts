...
const hr: Dict = {
	...
	'invite.doneTitle': 'Račun aktiviran',
	'reset.doneTitle': 'Lozinka promijenjena',
	// Shared validation / errors for the reset+invite forms
	'pw.tooShort': 'Lozinka mora imati najmanje 12 znakova.',
	'pw.tooLong': 'Lozinka može imati najviše 20 znakova.',
	'pw.badChars': 'Dopušteni su samo slova (a–z, A–Z), brojke i uobičajeni znakovi, bez razmaka.',
	'pw.hint': '12–20 znakova, bez razmaka.',
...
const en: Dict = {
	...
	'pw.tooLong': 'Password can be at most 20 characters.',
	'pw.badChars': 'Only letters (a–z, A–Z), digits and common symbols are allowed, no spaces.',
	'pw.hint': '12–20 characters, no spaces.',
