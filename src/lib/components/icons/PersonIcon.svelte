<script lang="ts">
	// Person glyph (user-provided, person-svgrepo): head + shoulders. Fill-based —
	// uses currentColor so it inherits the surrounding colour. "Momčad" rail item
	// (and reusable as an archer-card fallback).
